...
function HomeThree() {
            ...
            {expertiseTags.map((tag, index) => (
              <button
                ...
                className={`
                    ...
                    font-opensans text-sm md:text-base font-semibold
              ...
              <div className="w-full overflow-hidden  lg:rounded-none relative min-h-[400px] flex flex-col md:flex-row items-stretch">
                ...
                <div className="block md:hidden">
                  ...
                  <div className="bg-[#C09F53] p-6 sm:p-8 md:p-10 flex flex-col justify-center">
                    ...
                    <p className="text-white font-opensans text-base sm:text-lg md:text-xl font-normal leading-relaxed mb-6 md:mb-8 drop-shadow-md max-w-full">
                      We help victims file claims for asbestos-related diseases,
                      secure financial compensation for medical expenses and
                ...
                <div className="hidden md:flex w-full overflow-hidden lg:rounded-none relative min-h-[400px] items-center justify-start">
                  <img
                    src={masstortlap}
                    alt="X-ray or Medical Illustration"
                    className="w-full h-64 sm:h-80 md:h-[350px] lg:h-[500px] xl:h-[600px] 2xl:h-[700px] object-cover lg:rounded-none"
                  />

                  <div className="absolute inset-0 flex flex-col justify-center items-start p-4 md:p-8 lg:p-12 xl:p-16 2xl:p-20 w-full">
                    {/* Heading */}
                    <h2
                      className="text-white font-['Playfair_Display'] font-extrabold leading-tight mb-4 md:mb-6 drop-shadow-lg text-left break-words lg:whitespace-nowrap"
                    ...
                    {/* Paragraph */}
                    <p
                      className="text-white font-opensans font-normal leading-relaxed mb-6 md:mb-8 drop-shadow-md text-left max-w-full md:max-w-[75%] lg:max-w-[55%]"
              ...
              <div className="w-full overflow-hidden lg:rounded-none relative min-h-[400px] flex flex-col md:flex-row items-stretch">
                <div className="block md:hidden">
                  ...
                  <div className="bg-[#C09F53] p-6 sm:p-8 md:p-10 flex flex-col justify-center">
                    ...
                    <p className="text-white font-opensans text-base sm:text-lg md:text-xl font-normal leading-relaxed mb-6 md:mb-8 drop-shadow-md max-w-full">
                      We support survivors in taking legal action against
                      rideshare companies, seeking compensation and
                      accountability for assault and unsafe conditions. 
                    </p>
                    <button
                      className="rounded-full border-2 border-[#023437] px-6 md:px-8 py-3 md:py-4 text-[#023437] font-opensans text-base md:text-lg font-semibold bg-transparent self-start transition-all duration-300 hover:bg-[#023437] hover:text-[#C09F53] cursor-pointer drop-shadow-md"
                      onClick={() =>
  ...
  <h2
    ...
    style={{ fontSize: "clamp(28px, 6vw, 100px)" }}
  >
    Rideshare Sexual <br /> Assault Lawsuit
  </h2>
  ...
  <p
    ...
    style={{ fontSize: "clamp(16px, 2vw, 20px)" }}
  >
    We support survivors in taking legal action against rideshare companies,
    seeking compensation and accountability for assault and unsafe conditions.
  </p>
              ...
              <div className="w-full overflow-hidden lg:rounded-none relative min-h-[400px] flex flex-col md:flex-row items-stretch">
                <div className="block md:hidden">
                  ...
                  <div className="bg-[#C09F53] p-6 sm:p-8 md:p-10 flex flex-col justify-center">
                    ...
                    <p className="text-white font-opensans text-base sm:text-lg md:text-xl font-normal leading-relaxed mb-6 md:mb-8 drop-shadow-md max-w-full">
                      We help victims of trucking accidents pursue claims for
                      injuries, lost income, and damages caused by driver
  ...
  <h2
    ...
    style={{ fontSize: "clamp(28px, 6vw, 100px)" }}
  >
    18-Wheeler <br /> Accident Lawsuit
  </h2>
  ...
  <p
    ...
    style={{ fontSize: "clamp(16px, 2vw, 20px)" }}
  >
    We help victims of trucking accidents pursue claims for injuries, lost income,
    and damages caused by driver negligence or vehicle failure.
  </p>
  ...
  >
    Learn More
      ...
      <section className="w-full bg-[#023437] py-6 lg:py-10">
          ...
          <div className="flex flex-row items-end gap-4 lg:gap-16 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 mb-8 lg:mb-16">
            ...
            <div className="flex-1 flex justify-end items-end">
              <div className="max-w-md">
                <p className="text-[#FFFBF3] font-opensans text-sm sm:text-base md:text-lg lg:text-2xl leading-relaxed text-left">
                  Start in just a few steps,
                  <br />
                  where{" "}
                  <span className="text-[#C09F53]">
        ...
        {/* Steps Container */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-0 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20 font-opensans">
          {steps.map((step, index) => (
            ...
            >
              <p className="text-[#FFFBF3] font-opensans text-lg md:text-xl lg:text-2xl font-semibold">
                {step.number}
              </p>
              <h4 className="text-[#C09F53]  text-2xl md:text-3xl lg:text-4xl font-bold leading-tight underline font-opensans">
                {step.title}
              </h4>
              <p className="text-[#FFFBF3] font-opensans text-base md:text-lg lg:text-xl leading-relaxed">
                {step.description}
              </p>
            </div>
          ))}
