  ...
  return (
    <div>
      ...
      <div className="hidden md:block">
        <div className="min-h-screen object-cover relative overflow-hidden pt-"> {/* Added pt-20 here */}
         {/* Hero Text Section */}
          <div className="absolute z-10 left-[calc(50%-clamp(324px,97vw-(100vw-800px)*0.15,1600px)/2)] bottom-[clamp(500px,72.3vw,1600px)]">
  <div className="text-left w-full max-w-[90vw] md:max-w-[80vw] lg:max-w-[697px] xl:max-w-[1300px] 2xl:max-w-[1100px]">
    ...
    <h1 className="text-[#ffffff] font-['Playfair_Display'] text-[36px] md:text-[52px] lg:text-[72px] xl:text-[128px] 2xl:text-[120px] font-extrabold leading-[1.1] md:leading-[1.1] lg:leading-[72px] xl:leading-[130px] 2xl:leading-[120px] text-left">
      ...
      <div className="relative min-h-screen overflow-hidden pt-16">
        ...
        <div className="absolute z-10 top-[calc(16%+64px)] sm:top-[calc(15%+64px)] left-[5%] right-[5%]">
        ...
        <img
          src={aboutMobile}
          alt="About Us"
          className="w-auto h-full min-w-full absolute left-1/2 top-0 -translate-x-1/2 object-top"
        />
      </div>
    </div>
      </div>
