...
function ServiceOne() {
    ...
    <div className="relative w-full bg-[#023437] overflow-hidden mt-12 sm:mt-12 px-4 sm:px-6">
        ...
        <div className="w-full">
            ...
            <h2 className="text-[14px] sm:text-[16px] md:text-[18px] font-open-sans font-bold not-italic leading-tight text-[#C09F53] tracking-wide mb-1">
                Standing beside you  because 
            </h2>
    ...
    <div className="relative w-full bg-[#023437] overflow-hidden mt-0 ">
        {/* Images section */}
