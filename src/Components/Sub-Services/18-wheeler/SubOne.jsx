...
import Frames from "../../../assets/desk18.png";
import MobileFrames from "../../../assets/mob18.png"; 
    ...
    <div ref={currentSectionRef}>
      ...
      >
        ...
        <div className="flex flex-col justify-end items-start max-w-[90%] lg:max-w-[900px] xl:max-w-[1000px] 2xl:max-w-[1100px] h-full pb-16 md:pb-20 lg:pb-24 xl:pb-28 2xl:pb-32">
          <h1 className="text-[#FFFBF3] font-['Playfair_Display'] text-[32px] md:text-[42px] lg:text-[60px] xl:text-[80px] 2xl:text-[70px] font-extrabold leading-[1.1] md:leading-[1.2] mb-4 md:mb-6 lg:mb-8 text-left">
            18-Wheeler &  <br></br>Heavy Assault <span className='text-[#C09F53]'>Vehicle <br></br> Accident  </span>Lawsuit
          </h1>
          <div className="flex flex-col items-start w-full">
            <p className="text-[#C09F53] font-open-sans text-[5px] md:text-[9px] lg:text-[23px] xl:text-[17px] 2xl:text-[21px] font-bold leading-normal mb-2 md:mb-3 lg:mb-4 text-left">
              Supporting Survivors In Their Fight for Justice 
            </p>
       
            <p className="text-[#FFFBF3] font-open-sans text-[6px] md:text-[8px] lg:text-[10px] xl:text-[12px] 2xl:text-[14px] font-normal leading-relaxed text-left max-w-[600px] lg:max-w-[700px] xl:max-w-[800px]">
             We connect you with leading legal experts who guide them through every step of the claims process, working to secure compensation and accountability from rideshare companies. 
            </p>
          </div>
        </div>
...
Supporting Survivors In Their Fight for Justice           </p>
