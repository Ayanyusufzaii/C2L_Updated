    ...
    <div className="flex whitespace-nowrap animate-marquee">
        ...
        <div className="hidden md:block ml-16">
            ...
            <div className="w-full md:w-5/12 lg:w-6/12 p-6 md:p-8 lg:p-16 pl-0 md:pl-0 lg:pl-0 mt-6 md:mt-10 bg-[#FFFBF3]">
                <h2 className="w-full text-[#023437] font-['Open Sans'] text-lg md:text-xl lg:text-l font-semibold tracking-widest uppercase ] mt-1 mb-1">Rideshare Sexual Assault</h2>
...
{/*          
            ...
            <div className="w-full md:w-5/12 lg:w-6/12 p-6 md:p-8 lg:p-16 mt-6 md:mt-10 bg-[#FFFBF3]">
                <h3 className="text-[#C09F53] font-['Playfair_Display'] text-3xl md:text-4xl lg:text-5xl font-bold not-italic leading-none mb-12"><span className='text-[#023437]'>Evidence Required to  </span> <br />Support a Lawsuit</h3>
