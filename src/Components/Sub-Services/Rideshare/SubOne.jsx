    ...
    <div>
      ...
      <div className='hidden md:flex bg-[#023437] w-full min-h-[400px] h-[30vh] lg:h-[700px] xl:h-[850px] 2xl:h-[900px] flex-shrink-0 items-start justify-between p-2 md:p-6 lg:p-12 xl:p-20 relative mt-12 md:mt-12 lg:mt-20'>
        ...
        <div className="flex flex-col justify-between items-start max-w-[900px] pl-0 mt-8 md:mt-12 lg:mt-16 h-full pb-32 md:pb-36 lg:pb-40 xl:pb-48">
          <h1 className="text-[#FFFBF3] font-['Playfair_Display'] text-[28px] md:text-[52px] lg:text-[90px] xl:text-[110px] 2xl:text-[130px] font-extrabold leading-tight mb-6 md:mb-10 text-left whitespace-normal break-words">Rideshare Sexual Assault Lawsuit</h1>
          <div className="flex flex-col items-start w-full">
            <p className="text-[#FFFBF3] font-open-sans text-[15px] md:text-[20px] lg:text-[26px] xl:text-[32px] font-bold leading-normal mb-2 md:mb-4 text-left">Supporting Survivors In Their Fight for Justice  </p>
            <div className="w-2/3 md:w-1/2 h-[2px] bg-[#FFFBF3] mb-4 md:mb-6"></div>
            <p className="text-[#FFFBF3] font-open-sans text-[13px] md:text-[16px] lg:text-[20px] xl:text-[24px] font-normal not-italic leading-normal text-left">We connect you with leading legal experts who guide them through every step of the claims process, working to secure compensation and accountability from rideshare companies. </p>
          </div>
        </div>
