        ...
        <div className="md:hidden block overflow-x-hidden">
          <div>
            ...
            <div className="py-4 w-full flex justify-center px-4 pb-4">
              <img src={FooterGroup} alt="Connect2Lawyer Logo" className="w-full h-auto object-contain pb-4" />
            </div>

            {/* Contact info for Mobile */}
            <div className="flex flex-col space-y-4 ">
              <div className="flex items-center">
                <img className=" w-14 h-14" src={dialer} alt="Phone Icon" 
                onClick={handleCall}
                />
              ...
              <div className="flex items-center">
                <img className=" w-14 h-14" src={sms} alt="Mail Icon" 
                onClick={handleEmail}
                />
...
<div className="flex justify-center items-center px-2 pt-2">
  <div className="flex justify-between items-center w-full gap-2">
    ...
    <a
      ...
      className="flex items-center justify-center"
    >
      <img src={fb} alt="Facebook" className="w-10 h-10 sm:w-12 sm:h-12" />
    </a>
    <a
      href="https://www.instagram.com/connect2lawyer/"
      target="_blank"
      ...
      className="flex items-center justify-center"
    >
      <img src={insta} alt="Instagram" className="w-10 h-10 sm:w-12 sm:h-12" />
    </a>
    <a
      href="https://www.youtube.com/@connect2lawyer"
      target="_blank"
      ...
      className="flex items-center justify-center"
    >
      <img src={yt} alt="YouTube" className="w-10 h-10 sm:w-12 sm:h-12" />
    </a>
    <a
      href="https://www.tiktok.com/@connect2lawyer"
      target="_blank"
      ...
      className="flex items-center justify-center"
    >
      <img src={tiktok} alt="TikTok" className="w-10 h-10 sm:w-12 sm:h-12" />
    </a>
  </div>
</div>
              
              {/* Privacy Policy and Disclaimer - Below Social Icons */}
              <div className="flex justify-center gap-4 text-xs text-gray-300 pt-4">
      ...
      <div className="hidden md:block border-t border-teal-800 mt-8 pt-4 pb-4 px-2 sm:px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64">
