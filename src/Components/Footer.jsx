...
function Footer() {
  ...
  return (
    <div className="bg-[#023437] text-white w-full">
      <div className="max-w-7xl mx-auto pt-8 md:pt-16 px-2 md:px-6 lg:px-8">
            ...
            <div className="flex flex-col space-y-4 ">
              <div className="flex items-center font-opensans">
                <img
                  className="
      w-[48px] h-[48px]
      min-[375px]:w-[60px] min-[375px]:h-[60px]
      min-[425px]:w-[60px] min-[425px]:h-[60px]
      sm:w-[60px] sm:h-[60px]
      mr-2"
                  src={dialer}
                  alt="Phone Icon"
      ...
      min-[425px]:text-[18px]
      sm:text-[18px]
      font-semibold hover:underline break-words">
                    45 Monterey Bay Drive, Point Cook 3030, Melbourne, Victoria,
                    Australia
                  </span>
                </a>
