...
import AustraliaMap from "../../../assets/TASHERODESKTOP.png";
import AustraliaMapMob from "../../../assets/TASHEROMOBILE.png";
import AustraliaMapTab from "../../../assets/TASHERODESKTOP.png";
...
const HomeOneMobile = () => (
 ...
 <div className="w-full flex flex-col items-center px-4">
  <h1 className="text-left font-playfair  font-extrabold leading-snug text-[#023437] text-[36px]  sm:text-[36px] md:text-[40px]">
    ...
    <span className="text-[#C09F53] font-extrabold"> Tasmania </span>
  </h1>
...
Our TAS-based lawyers are ready to review cases involving asbestos exposure, heavy vehicle accidents, and rideshare incidents - starting today.
    </p>
  </div>
</div>
      ...
      />
       <div className="absolute top-0 left-0 w-2/3 p-6 flex flex-col items-start rounded-tl-lg font-playfair  ">
        <h1 className="text-left   font-semibold text-[#023437] leading-snug text-2xl md:text-3xl">
          ...
          for <span className="text-[#C9A74A] font-bold">Tasmania</span>
        </h1>
        <div className="mt-8">
