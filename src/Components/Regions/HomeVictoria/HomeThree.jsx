...
const contentConfig = {
  "Mesothelioma Lawsuits": {
    ...
    lawsuitTypeDesc:
      "Victoria Dust Disease Tribunal & civil compensation claims.",
    industriesTitle: "Industries",
    industriesDesc:
      "Construction, Shipbuilding, Electrical & Plumbing Trades, Renovation, Manufacturing.",
    imgSrc: oldladyimg,
  ...
  "18-Wheeler & Heavy Vehicle Accidents": {
    ...
    lawsuitTypeTitle: "Lawsuit Type",
    lawsuitTypeDesc:
      "TAC (no fault benefits), Common Law CTP claims, Workers’ Compensation if on the job. ",
    industriesTitle: "Industries",
    industriesDesc:
      "Freight & Logistics, Interstate Trucking, Agriculture Haulage, Mining Transport, Delivery Services.",
    imgSrc: truck,
  ...
  "Rideshare Sexual Assault": {
    ...
    lawsuitTypeTitle: "Lawsuit Type",
    lawsuitTypeDesc:
      "TAC CTP claims, Personal Injury claims under Victorian law, 3rd Party Property Damage.",
    industriesTitle: "Industries",
    industriesDesc:
      "Uber/DiDi/Ola, Food Delivery (Uber Eats, Menulog, DoorDash), Private Hire Vehicles. ",
    imgSrc: rideshare,
      ...
      >
        ...
        <div className="w-full max-w-full mx-auto px-4 sm:px-8 md:px-12 lg:px-16 xl:px-20 2xl:px-24 3xl:px-32 4xl:px-48 5xl:px-64">
          ...
          <h1 className="text-[#FFFBF3] font-playfair font-extrabold leading-tight mb-6 sm:mb-8 text-3xl sm:text-4xl md:text-5xl lg:text-[86px] xl:text-[125px] 2xl:text-[190px] 3xl:text-[190px] 4xl:text-[190px] 5xl:text-[190px]">
            Our Expertise in <span className="text-[#C09F53]">VIC</span>
          </h1>
