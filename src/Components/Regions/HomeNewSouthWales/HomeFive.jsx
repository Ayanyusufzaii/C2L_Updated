    ...
    <div>
      ...
      <div className="block lg:hidden bg-[#FFFF] pb-8">
        <div className="mx-auto">
          <h2 className="font-['Playfair_Display'] text-4xl font-bold text-[#023437] mb-12 text-center leading-tight p-6">
      ...
      <div className="hidden lg:block bg-[#FFFF] pb-8">
        <div className="mx-auto">
          <h2 className="font-['Playfair_Display'] text-4xl lg:text-6xl font-bold text-[#023437] mb-12 text-left leading-tight p-6">
