...
import AustraliaMap from "../../../assets/NewSouthWalesSemi.png";
import AustraliaMapMob from "../../../assets/NewSouthWalesMobileHero.png";
import AustraliaMapTab from "../../../assets/NewSouthWavlesHeroTablet.png";
...
const HomeOneMobile = () => (
 ...
 <div className="w-full flex flex-col items-center px-4">
  <h1 className="text-left font-playfair  font-extrabold leading-snug text-[#023437] text-[36px]  sm:text-[36px] md:text-[40px]">
    ...
    <span className="text-[#C09F53] font-extrabold"> New South Wales </span>
  </h1>
  <div className="mt-4 w-full">
    ...
    <p className="text-left font-opensans font-normal leading-relaxed text-[#023437] mt-2 text-[14px] xs:text-[16px] sm:text-[18px] md:text-[20px]">
      Our NSW-based lawyers are ready to review cases involving asbestos
      exposure, heavy vehicle accidents, and rideshare incidents – starting
      today.
    </p>
  </div>
</div>
    ...
    <div className="relative w-full max-w-4xl mx-auto">
      ...
      />
       <div className="absolute top-0 left-0 w-2/3 p-6 flex flex-col items-start rounded-tl-lg font-playfair  ">
        <h1 className="text-left   font-semibold text-[#023437] leading-snug text-2xl md:text-3xl font-playfair">
          Expert legal support <br />
          for <span className="text-[#C9A74A] font-bold">New South Wales</span>
        </h1>
        <div className="mt-8">
          ...
          <p className="text-[#023437] mt-2 leading-relaxed max-w-[22rem] text-sm md:text-base font-opensans ">
            Our NSW-based lawyers are ready to review cases involving asbestos,
            heavy vehicle accidents, and rideshare incidents – starting today.
          </p>
        </div>
      </div>
    </div>
        ...
        <div className="relative mx-auto">
          ...
          <div className="absolute top-0 left-0 flex flex-col items-start rounded-tl-lg">
            ...
            <div className="p-6 lg:p-8 xl:p-10 2xl:p-12 3xl:p-16 4xl:p-20 font-playfair ">
              <h1 className="text-left   font-semibold text-[#023437] leading-tight text-[32px] lg:text-[40px] xl:text-[50px] 2xl:text-[60px] 3xl:text-[72px] 4xl:text-[84px] font-playfair">
                Expert legal support <br />
                for{" "}
              ...
              <div className="mt-8 lg:mt-10 xl:mt-12 2xl:mt-14 3xl:mt-16 4xl:mt-20 max-w-md lg:max-w-lg xl:max-w-xl 2xl:max-w-2xl 3xl:max-w-3xl 4xl:max-w-4xl">
                ...
                <p className="text-[#023437] font-opensans mt-2 leading-relaxed text-[16px] lg:text-[17px] xl:text-[20px] 2xl:text-[24px] 3xl:text-[28px] 4xl:text-[32px]">
                  Our NSW-based lawyers are ready to review cases involving
                  asbestos exposure, heavy vehicle accidents, and rideshare
                  incidents – starting today.
                </p>
              </div>
            </div>
          </div>
