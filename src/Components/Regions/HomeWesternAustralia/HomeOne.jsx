...
import AustraliaMap from "../../../assets/WAHERODESKTOP.png";
import AustraliaMapMob from "../../../assets/WAHEROMOBILE.png";
import AustraliaMapTab from "../../../assets/WAHEROTABLET.png";
...
const HomeOneMobile = () => (
 ...
 <div className="w-full flex flex-col items-center px-4">
  <h1 className="text-left font-playfair  font-extrabold leading-snug text-[#023437] text-[36px]  sm:text-[36px] md:text-[40px]">
    ...
    <span className="text-[#C09F53] font-extrabold"> Western Australia </span>
  </h1>
  <div className="mt-4 w-full">
    ...
    <p className="text-left font-opensans font-normal leading-relaxed text-[#023437] mt-2 text-[14px] xs:text-[16px] sm:text-[18px] md:text-[20px]">
      Our WA-based lawyers are ready to review cases involving asbestos exposure, heavy vehicle accidents, and rideshare incidents - starting today.
    </p>
  </div>
</div>
      ...
      />
       <div className="absolute top-0 left-0 w-2/3 p-6 flex flex-col items-start rounded-tl-lg font-playfair  ">
        <h1 className="text-left   font-semibold text-[#023437] leading-snug text-2xl md:text-3xl">
          ...
          for <span className="text-[#C9A74A] font-bold">Western Australia</span>
        </h1>
        <div className="mt-8">
          <p className="text-[#023437] font-semibold text-base md:text-lg">
            Start your claim with no upfront fees.
          </p>
          <p className="text-[#023437] mt-2 leading-relaxed max-w-[22rem] text-sm md:text-[15px] font-opensans ">
            Our WA-based lawyers are ready to review cases involving asbestos exposure, heavy vehicle accidents, and rideshare incidents - starting today.
          </p>
        </div>
      </div>
