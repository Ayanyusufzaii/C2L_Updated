...
import AustraliaMap from "../../../assets/SAHERODESKTOP.png";
import AustraliaMapMob from "../../../assets/SAHEROMOBILE.png";
import AustraliaMapTab from "../../../assets/SAHEROTABLET.png";
...
const HomeOneMobile = () => (
 ...
 <div className="w-full flex flex-col items-center px-4">
  <h1 className="text-left font-playfair  font-extrabold leading-snug text-[#023437] text-[36px]  sm:text-[36px] md:text-[40px]">
    ...
    <span className="text-[#C09F53] font-extrabold"> South Australia </span>
  </h1>
  <div className="mt-4 w-full">
    ...
    <p className="text-left font-opensans font-normal leading-relaxed text-[#023437] mt-2 text-[14px] xs:text-[16px] sm:text-[18px] md:text-[20px]">
      Our SA-based lawyers are ready to review cases involving asbestos exposure, heavy vehicle accidents, and rideshare incidents - starting today.
    </p>
  </div>
</div>
