...
const contentConfig = {
  "Mesothelioma Lawsuits": {
    ...
    lawsuitTypeDesc:
      "Personal injury claims under ACT civil law, focusing on negligence and occupational exposure.",
  ...
  "18-Wheeler & Heavy Vehicle Accidents": {
    ...
    lawsuitTypeTitle: "Lawsuit Type",
    lawsuitTypeDesc:
      "Claims under the MAI Scheme, with potential for common law actions in cases of serious injury.",
    industriesTitle: "Industries",
    industriesDesc:
      "Freight transport, logistics, and public works.",
    imgSrc: truck,
  ...
  "Rideshare Accident Claims": {
    ...
    lawsuitTypeTitle: "Lawsuit Type",
    lawsuitTypeDesc:
      "MAI Scheme claims, encompassing both no-fault benefits and fault-based compensation.",
    industriesTitle: "Industries",
    industriesDesc:
      "Rideshare services (e.g., Uber, Ola), food delivery, and private hire vehicles.",
    imgSrc: rideshare,
      ...
      >
        ...
        <div className="w-full max-w-full mx-auto px-4 sm:px-8 md:px-12 lg:px-16 xl:px-20 2xl:px-24 3xl:px-32 4xl:px-48 5xl:px-64">
          ...
          <h1 className="text-[#FFFBF3] font-playfair font-extrabold leading-tight mb-6 sm:mb-8 text-3xl sm:text-4xl md:text-5xl lg:text-[86px] xl:text-[125px] 2xl:text-[190px] 3xl:text-[190px] 4xl:text-[190px] 5xl:text-[190px]">
            Our Expertise in <span className="text-[#C09F53]">ACT</span>
          </h1>
