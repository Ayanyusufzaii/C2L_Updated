        ...
        <div className="w-full max-w-[1540px] h-auto flex-shrink-0 bg-[#C09F53] pb-16">
          ...
          <div className='mt-[-5px]'>
            <h1 className="text-[#FFFBF3] font-['Playfair_Display'] text-[44px] font-extrabold leading-[70px] w-full ml-16 mt-10">
              <span className="text-custom-light font-opensans  text-[80px] font-semibold leading-none mr-10">01</span>You were injured in a truck collision</h1>
          ...
          <div className='mt-[-5px]'>
            <h1 className="text-[#FFFBF3] font-['Playfair_Display'] text-[44px] font-extrabold leading-[70px] w-full ml-16 mt-10">
              <span className="text-custom-light font-opensans  text-[80px] font-semibold leading-none mr-10">02</span>You were working when the accident occurred</h1>
            <p className="w-[805px] text-[#023437] font-open-sans text-[24px] font-normal leading-none mx-auto mt-4">
          ...
          <div className='mt-[-5px]'>
            <h1 className="text-[#FFFBF3] font-['Playfair_Display'] text-[44px] font-extrabold leading-[70px] w-full ml-16 mt-10">
              <span className="text-custom-light font-opensans  text-[80px] font-semibold leading-none mr-10">03</span> A loved one was injured or killed in a truck accident</h1>
            <p className="w-[805px] text-[#023437] font-open-sans text-[24px] font-normal leading-none mx-auto mt-4">
          ...
          <div className='mt-[-5px]'>
            <h1 className="text-[#FFFBF3] font-['Playfair_Display'] text-[44px] font-extrabold leading-[70px] w-full ml-16 mt-10">
              <span className="text-custom-light font-opensans  text-[80px] font-semibold leading-none mr-10">04</span> You developed long-term health issues</h1>
            <p className="w-[805px] text-[#023437] font-open-sans text-[24px] font-normal leading-none mx-auto mt-4">
